...
enum BreakingDebug { OFF, DEPTH, STEEPNESS, CRESTNESS, PREBREAK, OPEN_BREAK, DEPTH_BREAK, BREAK_ONSET, BREAK_STRENGTH, PARENT_HEIGHT, PARENT_CREST_SCALE, BAND_ATTRIBUTION }
...
const _BREAKING_DEBUG_NAMES := ["OFF", "DEPTH", "STEEPNESS", "CRESTNESS", "PREBREAK", "OPEN_BREAK", "DEPTH_BREAK", "BREAK_ONSET", "BREAK_STRENGTH", "PARENT_HEIGHT", "PARENT_CREST_SCALE", "BAND_ATTRIBUTION"]
