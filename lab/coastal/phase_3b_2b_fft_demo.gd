...
enum BreakingDebug { OFF, DEPTH, STEEPNESS, CRESTNESS, PREBREAK, OPEN_BREAK, DEPTH_BREAK, BREAK_ONSET }
...
const _BREAKING_DEBUG_NAMES := ["OFF", "DEPTH", "STEEPNESS", "CRESTNESS", "PREBREAK", "OPEN_BREAK", "DEPTH_BREAK", "BREAK_ONSET"]
